...
import com.dhcc.ecm.WANO.exception.BizResponse;
import com.dhcc.ecm.WANO.exception.ErrorCode;
import com.dhcc.ecm.WANO.file.TInstanceFileService;
import com.dhcc.ecm.WANO.mybatis.file.model.TInstanceFile;
import com.dhcc.ecm.WANO.util.WANOProperties;
import com.dhcc.ecm.WANO.util.GlobalConstants;
...
public class TInstanceFileController extends AbstractRestHandler {
	...
	@Autowired
	private WANOProperties properties;
